...
use Taller\Bundle\GageBundle\Entity\Curso;
use Taller\Bundle\GageBundle\Form\CursoType;
...
class CursoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TallerGageBundle:Curso')->findAll();
     ...
     * @Method("POST")
     * @Template("TallerGageBundle:Curso:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TallerGageBundle:Curso')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TallerGageBundle:Curso:edit.html.twig")
     */
