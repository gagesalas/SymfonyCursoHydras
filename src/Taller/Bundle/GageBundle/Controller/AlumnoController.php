...
use Taller\Bundle\GageBundle\Entity\Alumno;
use Taller\Bundle\GageBundle\Form\AlumnoType;
...
class AlumnoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TallerGageBundle:Alumno')->findAll();
     ...
     * @Method("POST")
     * @Template("TallerGageBundle:Alumno:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TallerGageBundle:Alumno')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TallerGageBundle:Alumno:edit.html.twig")
     */
