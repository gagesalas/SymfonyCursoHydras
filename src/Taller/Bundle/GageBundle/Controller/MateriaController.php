...
namespace Taller\Bundle\GageBundle\Controller;
...
use Taller\Bundle\GageBundle\Entity\Materia;
use Taller\Bundle\GageBundle\Form\MateriaType;
...
class MateriaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TallerGageBundle:Materia')->findAll();
     ...
     * @Method("POST")
     * @Template("TallerGageBundle:Materia:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TallerGageBundle:Materia')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TallerGageBundle:Materia:edit.html.twig")
     */
