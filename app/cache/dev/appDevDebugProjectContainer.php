...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/xampp/htdocs/app/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\ConfigurationResource(array('bootstrap_css' => array(0 => array(0 => 'C:/xampp/htdocs/app/../vendor/twbs/bootstrap/less/bootstrap.less', 1 => 'C:/xampp/htdocs/app/../vendor/twbs/bootstrap/less/responsive.less'), 1 => array(0 => 'lessphp', 1 => 'cssrewrite'), 2 => array('output' => '/css/bootstrap.css')), 'bootstrap_js' => array(0 => array(0 => 'C:/xampp/htdocs/app/../vendor/twbs/bootstrap/js/bootstrap-transition.js', 1 => 'C:/xampp/htdocs/app/../vendor/twbs/bootstrap/js/bootstrap-alert.js', 2 => 'C:/xampp/htdocs/app/../vendor/twbs/bootstrap/js/bootstrap-button.js', 3 => 'C:/xampp/htdocs/app/../vendor/twbs/bootstrap/js/bootstrap-carousel.js', 4 => 'C:/xampp/htdocs/app/../vendor/twbs/bootstrap/js/bootstrap-collapse.js', 5 => 'C:/xampp/htdocs/app/../vendor/twbs/bootstrap/js/bootstrap-dropdown.js', 6 => 'C:/xampp/htdocs/app/../vendor/twbs/bootstrap/js/bootstrap-modal.js', 7 => 'C:/xampp/htdocs/app/../vendor/twbs/bootstrap/js/bootstrap-tooltip.js', 8 => 'C:/xampp/htdocs/app/../vendor/twbs/bootstrap/js/bootstrap-popover.js', 9 => 'C:/xampp/htdocs/app/../vendor/twbs/bootstrap/js/bootstrap-scrollspy.js', 10 => 'C:/xampp/htdocs/app/../vendor/twbs/bootstrap/js/bootstrap-tab.js', 11 => 'C:/xampp/htdocs/app/../vendor/twbs/bootstrap/js/bootstrap-typeahead.js', 12 => 'C:/xampp/htdocs/app/../vendor/twbs/bootstrap/js/bootstrap-affix.js'), 1 => array(), 2 => array('output' => '/js/bootstrap.js')), 'jquery' => array(0 => array(0 => 'C:/xampp/htdocs/app/../vendor/jquery/jquery/jquery-1.9.1.js'), 1 => array(), 2 => array('output' => '/js/jquery.js')))), 'config');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/xampp/htdocs/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    {
        require_once 'C:/xampp/htdocs/app/../vendor/leafo/lessphp/lessc.inc.php';
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/xampp/htdocs/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_8d0e587391dce5327896a0b237b01115');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_8d0e587391dce5327896a0b237b01115');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_8d0e587391dce5327896a0b237b01115');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\xampp\\htdocs\\src\\Taller\\Bundle\\GageBundle\\Entity')), 'Taller\\Bundle\\GageBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('TallerGageBundle' => 'Taller\\Bundle\\GageBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('C:/xampp/htdocs/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/xampp/htdocs/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'eb87ae83b5b8c41a17de160de09c551aa281b25b');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/xampp/htdocs/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/xampp/htdocs/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/xampp/htdocs/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/xampp/htdocs/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp/htdocs/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/xampp/htdocs/app', 'UTF-8');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/xampp/htdocs/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/xampp/htdocs/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\xampp\\htdocs\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\xampp\\htdocs\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\xampp\\htdocs\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\xampp\\htdocs\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\xampp\\htdocs\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\xampp\\htdocs\\src\\Taller\\Bundle\\GageBundle/Resources/views', 'TallerGage');
        $instance->addPath('C:\\xampp\\htdocs\\vendor\\braincrafted\\bootstrap-bundle\\Bc\\Bundle\\BootstrapBundle/Resources/views', 'BcBootstrap');
        $instance->addPath('C:\\xampp\\htdocs\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('C:\\xampp\\htdocs\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\xampp\\htdocs\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/xampp/htdocs/app/Resources/views');
        $instance->addPath('C:\\xampp\\htdocs\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('eb87ae83b5b8c41a17de160de09c551aa281b25b');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp/htdocs/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/xampp/htdocs/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp/htdocs/app/cache/dev');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/xampp/htdocs/app/cache/dev',
            'kernel.logs_dir' => 'C:/xampp/htdocs/app/logs',
            'kernel.bundles' => array(
                ...
                'TallerGageBundle' => 'Taller\\Bundle\\GageBundle\\TallerGageBundle',
            ...
            'locale' => 'en',
            'secret' => 'eb87ae83b5b8c41a17de160de09c551aa281b25b',
            'database_path' => NULL,
            ...
            'debug.container.dump' => 'C:/xampp/htdocs/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => 'eb87ae83b5b8c41a17de160de09c551aa281b25b',
            ...
            'session.save_path' => 'C:/xampp/htdocs/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\xampp\\htdocs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:C:/xampp/htdocs/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/xampp/htdocs/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/xampp/htdocs/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/xampp/htdocs/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/xampp/htdocs/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/xampp/htdocs/app/../web',
            'assetic.write_to' => 'C:/xampp/htdocs/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp/htdocs/app/cache/dev/doctrine/orm/Proxies',
